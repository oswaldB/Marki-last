Voici un document structuré avec **le style guide complet**, **la configuration Tailwind en JSON**, et **les snippets des composants clés** (sans répétition du HTML de base). Tout est prêt pour une intégration rapide dans vos projets **Steroids Studio**.
